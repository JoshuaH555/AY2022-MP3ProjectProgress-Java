...
public final class MainActivity extends AppCompatActivity
  ...
  public boolean longPressHelper(final GeoPoint p) {
    Intent addFavoritePlace = new Intent(this, AddPlaceActivity.class);
    addFavoritePlace.putExtra("latitude", Double.toString(p.getLatitude()));
    addFavoritePlace.putExtra("longitude", Double.toString(p.getLongitude()));
    startActivity(addFavoritePlace);
    return false;
  }
}
